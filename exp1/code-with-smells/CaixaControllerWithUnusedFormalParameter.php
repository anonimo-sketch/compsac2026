...
class CaixaControllerWithUnusedFormalParameter extends Controller
{
    ...
    public function addCaixaView($price, $quantity, $discount)
    {
        $value = $price * $quantity;

        return view('admin.caixa.adicionar', ['aberto' => $this->caixaModel->checkOpen(), 'value' => $value]);
    }
}
