...
class CaixaControllerWithExcessiveParameterList extends Controller
{
    ...
    public function addCaixaView($name, $email, $password, $address, $phone, $birthdate, $gender)
    {
        $user = $this->caixaModel;
        $user->setName($name);
        $user->setEmail($email);
