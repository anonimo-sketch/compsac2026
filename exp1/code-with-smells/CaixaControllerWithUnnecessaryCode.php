...
class CaixaControllerWithUnnecessaryCode extends Controller
{
    ...
    public function addCaixaView($price, $quantity)
    {
        $total = $price * $quantity;
        return view('admin.caixa.adicionar', ['aberto' => $this->caixaModel->checkOpen(), 'total' => $total]);
        echo "Total calculado $total"; // Nunca será executado
    }
}
